...
summary_s1b_df <- s1b_df %>%
  ...
  summarize(mean=mean(log_cfu_g),
            ...
            cv=sd/mean*100,
            n=n())
# write.csv(summary_s1b_df,"stage1b_summary_bypowder.csv")
...
summary_s1b_df2 <- s1b_df %>%
  ...
  summarize(OverallMean=mean(mean),
            Overallsd=sd(mean),
            n=n())
# write.csv(summary_s1b_df2,"stage1b_summary_bystrategy.csv")
```
...
summary_s2_df2c <- s2_df2 %>%
  ...
  summarize(mean=mean(log_mean_count),
            ...
            cv=sd/mean*100,
            n=n())
# write.csv(summary_s2_df2c,"stage2_summary_bypowder.csv")
```
...
summary_s3_dfc <- s3_df %>%
  ...
  summarize(mean=mean(log_mean_count),
            ...
            cv=sd/mean*100,
            n=n())
# write.csv(summary_s3_dfc,"stage3_summary_bypowder.csv")
```
